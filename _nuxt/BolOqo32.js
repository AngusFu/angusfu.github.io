...
`)])],-1),s("p",null,[l("如果你想看真实效果，这有一个"),s("a",{href:"https://www.youtube.com/watch?v=zc420bXDqWk",target:"_blank",rel:"noopener"},"讲述各个细节的快速视频教程"),l("。")],-1),s("p",null,"视频在最后的代码部分有点 bug，因为我没将 count 属性和 undefined 对比，所以在第一个元素上，键盘功能没法正常工作（0 是 falsy）。",-1)])]),_:1})}}};export{d as default};
