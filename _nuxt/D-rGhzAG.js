...
`),s("span",{class:"hljs-built_in"},"command"),n(` finished  
disconnecting 
`)])],-1),s("p",null,"这里我们可以看到，所有命令被立即放到队列中，并且命令是被一些随机时间间隔着有序完成的。最后，所有命令完成之后连接切断。",-1),s("h2",null,"下一篇文章",-1),s("p",null,"本系列的下一篇文章，我们将探索如何避免崩溃以及通过持久化工作项目来限制内存影响。",-1)])]),_:1})}}};export{d as default};
