...
`)])],-1),s("p",null,[l("做个笔记： Blob对象和base64字符串的转换, "),s("a",{href:"http://jsperf.com/blob-base64-conversion",target:"_blank",rel:"noopener"},"http://jsperf.com/blob-base64-conversion")],-1),s("p",null,"目前还没在IE上测试过，不知道结果如何。 ",-1)])]),_:1})}}};export{m as default};
