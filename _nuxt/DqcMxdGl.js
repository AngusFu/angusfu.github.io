import{_ as e}from"./BV7Yc4PX.js";import{c,w as r,o as p,a as s,b as a}from"./B1kHp8qp.js";import"./8oskhlv7.js";const m={__name:"rxjs-http-timeout",setup(o){const n={title:"Angular 2 中的 HTTP 请求超时处理",description:"Angular 2 中的 HTTP 请求超时处理",keywords:"原创,笔记,RxJS,Angular 2",pathname:"rxjs-http-timeout",translation:null,create_time:"2017-01-16",prev:{title:"笔记：如何获取网站根域名",pathname:"get-root-domain-of-a-site"},next:{title:"关于时序攻击",pathname:"timing-atack"}};return(i,l)=>{const t=e;return p(),c(t,{data:n},{default:r(()=>[...l[0]||(l[0]=[s("p",null,[a("以前做 React Native 时，需要对请求进行超时处理。然而，React Native 提供的 "),s("code",null,"fetch"),a(" 方法，根本没有提供超时的选择。于是只能自己玩些如下的黑科技了，代码一看就很乱，还难以维护：")],-1),s("pre",null,[s("code",{class:"hljs lang-javascript"},[s("span",{class:"hljs-keyword"},"const"),a(),s("span",{class:"hljs-variable constant_"},"TIME_OUT"),a(" = "),s("span",{class:"hljs-number"},"3000"),a(`;
...
`),s("span",{class:"hljs-comment"},"// ..."),a(`
`)])],-1),s("p",null,"暂且记录成这样吧，有空再补充。",-1)])]),_:1})}}};export{m as default};
