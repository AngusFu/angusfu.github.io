...
`)])],-1),s("p",null,[l("还有一些非变动方法，包括 "),s("a",{href:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/map",target:"_blank",rel:"noopener"},"`map`"),l("、"),s("a",{href:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/filter",target:"_blank",rel:"noopener"},"`filter`"),l("、"),s("a",{href:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/reduce",target:"_blank",rel:"noopener"},"`reduce`"),l(" 等。")],-1),s("h3",null,"避免变动：对象",-1),s("p",null,[l("可以使用 "),s("a",{href:"https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Global_Objects/Object/assign",target:"_blank",rel:"noopener"},"`Object.assign`"),l(" 方法，而非直接编辑对象。该方法将源对象的属性复制到目标对象中，并将目标对象返回。如果总是用一个空对象作为目标对象，就能通过 "),s("code",null,"Object.assign"),l(" 避免直接编辑对象。")],-1),s("pre",null,[s("code",{class:"hljs lang-javascript"},[s("span",{class:"hljs-keyword"},"const"),l(" objectOne = { valueOne : "),s("span",{class:"hljs-number"},"1"),l(` };
