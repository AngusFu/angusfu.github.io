...
`)])],-1),s("h2",null,"运行测试用例",-1),s("p",null,"现在我们完成了应用的测试用例和控制器逻辑两部分。来跑一下测试，看看最终结果：",-1),s("pre",null,[s("code",{class:"hljs lang-bash"},[l("> npm "),s("span",{class:"hljs-built_in"},"test"),l(`
  ...
  8 passing (34ms) 
`)])],-1),s("p",null,"最终结果显示，我们所有的测试用例都通过了。接下来的步骤应该是 API 重构，这包含着重复本教程提到的相同过程。",-1),s("h2",null,"结论",-1),s("p",null,"通过本教程，我们学习了如果使用测试驱动开发的办法，用 Node.js and MongoDB 设计 API。尽管 TDD （测试驱动开发）给开发过程带来了额外复杂度，它能帮我们建立更稳定的、错误更少的应用。就算你不想实践 TDD， 至少也应该编写覆盖应用所有功能点的测试。",-1),s("p",null,"如果你有任何问题或想法，请不吝留言。",-1)])]),_:1})}}};export{u as default};
