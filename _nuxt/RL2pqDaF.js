import{_ as e}from"./BV7Yc4PX.js";import{c,w as p,o as r,a as s,b as a}from"./B1kHp8qp.js";import"./8oskhlv7.js";const m={__name:"ie-filter",setup(i){const n={title:"笔记：IE 下透明度问题",description:"IE 下透明度问题记录",keywords:"原创,CSS",pathname:"ie-filter",translation:null,create_time:"2016-11-14",prev:{title:"[译] 手把手教你写一个 Javascript 框架：数据绑定",pathname:"data-bind-dirty-checking"},next:{title:"快来上钩哈哈哈",pathname:"fishing-for-spider"}};return(h,l)=>{const t=e;return r(),c(t,{data:n},{default:p(()=>[...l[0]||(l[0]=[s("p",null,"IE8 下面遇到奇怪的问题。本来半透明的 png 图片，竟然一片黑。",-1),s("p",null,[s("img",{loading:"lazy",src:"https://p1.ssl.qhimg.com/t01685a11ad71082aa5.png",alt:""})],-1),s("p",null,[a("然而，我明明按照习惯使用了 "),s("code",null,"opacity + filter"),a(" 的方式。")],-1),s("pre",null,[s("code",{class:"hljs lang-css"},[s("span",{class:"hljs-selector-tag"},"img"),a(` {
